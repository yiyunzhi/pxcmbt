...
from .panel_user_feature_selector import UserPanelSelectorPanel


class SelectUserFeatureDialog(wx.Dialog):
    def __init__(self, project, parent, wx_id=wx.ID_ANY, title='SelectUserFeature', size=wx.DefaultSize,
                 pos=wx.DefaultPosition,
                 style=wx.DEFAULT_DIALOG_STYLE | wx.RESIZE_BORDER, name='SelectUserFeatureDialog'):
        wx.Dialog.__init__(self, parent, wx_id, title, pos, size, style, name)
        self.mainSizer = wx.BoxSizer(wx.VERTICAL)
        self.project = project
        self.selectorPanel = UserPanelSelectorPanel(self.project, self)
