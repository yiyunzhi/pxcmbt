...
class ConsolePanel(wx.Panel):
    ...
    def __init__(self, **kwargs):
        ...
        #EnumRackPanelSignals.sigM2VWriteInfoToConsole.connect(self.on_write_info_to_console)
        #EnumRackPanelSignals.sigM2VWriteWarningToConsole.connect(self.on_write_warning_to_console)
        #EnumRackPanelSignals.sigM2VWriteErrorToConsole.connect(self.on_write_error_to_console)
